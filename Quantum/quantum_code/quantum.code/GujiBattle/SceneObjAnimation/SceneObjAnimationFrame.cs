...
{
    [Serializable]
    public struct SceneObjAnimationFrame
    {
        public int id;
        public FP time;
        ...
        public static SceneObjAnimationFrame operator +(SceneObjAnimationFrame a, SceneObjAnimationFrame b)
        {
            return new SceneObjAnimationFrame()
            {
                id = a.id + b.id,
                time = a.time + b.time,
        ...
        public static SceneObjAnimationFrame operator *(SceneObjAnimationFrame a, FP b)
        {
            return new SceneObjAnimationFrame()
            {
                id = (a.id * b).AsInt,
        ...
        public static SceneObjAnimationFrame Lerp(SceneObjAnimationFrame a, SceneObjAnimationFrame b, FP value)
        {

...
namespace MK.Toon
{
    public static class Properties
    {
        ...
        public static readonly ColorProperty maskColor                           = new ColorProperty(Uniforms.maskColor);
        public static readonly TextureProperty maskMap                           = new TextureProperty(Uniforms.maskMap, Keywords.maskMap);

...
//////////////////////////////////////////////////////
	...
	UNIFORM_TEXTURE_2D(_MaskMap);					//7
	UNIFORM_TEXTURE_2D(_HeightMap);					//8
	UNIFORM_TEXTURE_2D(_ThicknessMap);				//9
	UNIFORM_TEXTURE_2D(_OcclusionMap);				//10
	UNIFORM_TEXTURE_2D(_ThresholdMap);				//11
	UNIFORM_TEXTURE_2D(_GoochRamp);					//12
	UNIFORM_TEXTURE_2D(_DiffuseRamp);				//13
	UNIFORM_TEXTURE_2D(_SpecularRamp);				//14
	UNIFORM_TEXTURE_2D(_RimRamp);					//15
	UNIFORM_TEXTURE_2D(_LightTransmissionRamp);		//16
	UNIFORM_TEXTURE_2D(_IridescenceRamp);			//17
	UNIFORM_TEXTURE_2D(_SketchMap);					//18
	UNIFORM_TEXTURE_2D(_DrawnMap);					//18
	UNIFORM_TEXTURE_2D(_HatchingBrightMap);			//18
	UNIFORM_TEXTURE_2D(_HatchingDarkMap);			//19
	UNIFORM_TEXTURE_2D(_GoochBrightMap);			//20
	UNIFORM_TEXTURE_2D(_GoochDarkMap);				//21
	UNIFORM_TEXTURE_2D(_DissolveMap);				//22
	UNIFORM_TEXTURE_2D(_DissolveBorderRamp);		//23
	UNIFORM_TEXTURE_2D(_EmissionMap);				//24
	uniform sampler2D _VertexAnimationMap;			//25
	//Depth											//26
	//Refraction									//27

...
namespace MK.Toon.Editor
{
    ...
    internal abstract class SimpleEditorBase : UnlitEditorBase
    {
        ...
        protected MaterialProperty _maskColor;
        protected MaterialProperty _maskMap;
        ...
        protected override void FindProperties(MaterialProperty[] props)
        {
            ...
            _maskColor = FindProperty(Properties.maskColor.uniform.name, props);
            _maskMap = FindProperty(Properties.maskMap.uniform.name, props);
        ...
        protected virtual void DrawMaskMap(MaterialEditor materialEditor)
        {
            EditorGUI.BeginChangeCheck();
            materialEditor.TexturePropertySingleLine(UI.maskMap, _maskMap, _maskColor);
            if (EditorGUI.EndChangeCheck())
            {
                ManageKeywordsMaskMap();
            }
        }
        ...
        private void ManageKeywordsMaskMap()
        {
            //Colorsource
            foreach (Material mat in _maskMap.targets)
            {
                EditorHelper.SetKeyword(Properties.maskMap.GetValue(mat), Keywords.maskMap, mat);
